...
func _ready(): 
	#board setup
	board.append([4, 2, 3, 5, 6, 3, 2, 4]) #white pieces
	board.append([1, 1, 1, 1, 1, 1, 1, 1]) #white pawns
	board.append([0, 0, 0, 0, 0, 0, 0, 0])
	board.append([0, 0, 0, 0, 0, 0, 0, 0])
	board.append([0, 0, 0, 0, 0, 0, 0, 0])
	board.append([0, 0, 0, 0, 0, 0, 0, 0])
	board.append([-1, -1, -1, -1, -1, -1, -1, -1]) #black pawns
	board.append([-4, -2, -3, -5, -6, -3, -2, -4]) #black pieces
